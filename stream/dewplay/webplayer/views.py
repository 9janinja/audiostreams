...
def index_id(request, sid):
	...
	return render(request, 'dewplayTemplates/webplayer/index.html', {'data':data, 'song':song, 'pid': prev_id, 'nid':next_id, 'fav':fav})
...
def favorites(request):
	if request.META.get('HTTP_X_REQUESTED_WITH') == 'XMLHttpRequest':
		...
		if not 'action' in request.POST.keys():
			return JsonResponse({'key':'0', 'msg':'Missing Parameters!'})
...
def favorites_list(request, sid):
	...
	return render(request, 'dewplayTemplates/webplayer/favorite.html', {'fav_data':fav_data, 'song':song, 'pid': prev_id, 'nid':next_id, 'fav':fav})
...
def artist(request, sid):
	...
	return render(request, 'dewplayTemplates/webplayer/artist.html', {'artist':artist, 'song':song, 'pid': prev_id, 'nid':next_id, 'fav':fav})
...
def artist_details(request, sid, aid):
	...
	return render(request, 'dewplayTemplates/webplayer/artist-details.html', {'artist':artist, 'art_songs':art_songs, 'song':song, 'pid': prev_id, 'nid':next_id, 'fav':fav})
...
def mood(request, sid):
	...
	return render(request, 'dewplayTemplates/webplayer/mood.html', {'mood':mood, 'song':song, 'pid': prev_id, 'nid':next_id, 'fav':fav})
...
def mood_details(request, sid, mid):
	...
	return render(request, 'dewplayTemplates/webplayer/mood-details.html', {'mood':mood, 'mood_songs':mood_songs, 'song':song, 'pid': prev_id, 'nid':next_id, 'fav':fav})
...
def genre(request, sid):
	...
	return render(request, 'dewplayTemplates/webplayer/genre.html', {'genre':genre, 'song':song, 'pid': prev_id, 'nid':next_id, 'fav':fav})
...
def genre_details(request, sid, gid):
	...
	return render(request, 'dewplayTemplates/webplayer/genre-details.html', {'genre':genre, 'genre_songs':genre_songs, 'song':song, 'pid': prev_id, 'nid':next_id, 'fav':fav})
...
def category(request, sid):
	...
	return render(request, 'dewplayTemplates/webplayer/category.html', {'genre':genre, 'mood':mood, 'artist':artist, 'data':data, 'song':song, 'pid': prev_id, 'nid':next_id, 'fav':fav})
...
def library(request, sid):
	...
	return render(request, 'dewplayTemplates/webplayer/library.html', {'song_data':song_data, 'song':song, 'pid': prev_id, 'nid':next_id, 'fav':fav})
...
def search(request, sid):
	...
	if request.method == 'GET':
		...
		if 'search' in request.GET.keys():
			...
			return render(request, 'dewplayTemplates/webplayer/search.html', {'song_data':song_data,'song':song, 'pid': prev_id, 'nid':next_id, 'fav':fav})
			...
			return render(request, 'dewplayTemplates/webplayer/search.html', {'song':song, 'pid': prev_id, 'nid':next_id, 'fav':fav})
