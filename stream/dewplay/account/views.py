...
def index(request):
	...
	return render(request, 'dewplayTemplates/account/index.html', {'usr':usr})
...
def edit(request):
	...
	return render(request, 'dewplayTemplates/account/edit.html', {'usr':usr})
...
def edit_pass(request):
	...
	if not usr:
		...
		usr = usr.get()
	return render(request, 'dewplayTemplates/account/edit-pass.html', {'usr':usr})
...
def privacy(request):
	...
	if not usr:
		...
		usr = usr.get()
	return render(request, 'dewplayTemplates/account/privacy.html', {'usr':usr})
...
def subs(request):
	...
	if not usr:
		...
		usr = usr.get()
	return render(request, 'dewplayTemplates/account/subscription.html', {'usr':usr})
